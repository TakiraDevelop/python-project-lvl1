Создано по заданию Hexlet. В проекте 5 игр. В начале любого запуска происходит приветствие и запрос имени, также описывается задание игры. Каждая игра имеет 3 раунда.
